...
const About = () => {
  return (
    <div className='py-10 flex flex-col justify-center px-5 items-center gap-5 tablet:px-[8vw] desktop:px-[10vw]'>
        <span className='pt-10 text-center underline-offset-4 underline text-3xl'>ABOUT ME</span>
        <section className='text-center pt-5 px-7 text-xl'>
          ...
          <br />
          <b className='underline underline-offset-2 text-2xl'>My Expertise</b>
          <p className='text-left'>
          ...
          <br />
          <b className='underline underline-offset-2 text-2xl'>Professional Journey</b>
          <p className='text-left'>
          ...
          <br />
          <b className='underline underline-offset-2 text-2xl'>My Approach</b>
          <p className='text-left'>
          ...
          <br />
          <b className='underline underline-offset-2 text-2xl'>Continued Growth</b>
          <p className='text-left'>
          ...
          <br />
          <b className='underline underline-offset-2 text-2xl'>Get in Touch</b>
          <p className='text-left'>
        ...
        <section className='border-t-2 w-full flex justify-center items-center py-10'>
           <a href="./GodsWilOnwuchekwaResumeUpdated.v3.pdf" download="Godswil Onwuchekwa CV" className='border-2 px-5 py-2 rounded-md'>
               Download CV
           </a>
        </section>
    </div>
